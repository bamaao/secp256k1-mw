 ...
 */
static int secp256k1_bulletproof_inner_product_prove_impl(const secp256k1_ecmult_context *ecmult_ctx, secp256k1_scratch *scratch, const secp256k1_callback *error_callback, secp256k1_scalar *final_a, secp256k1_scalar *final_b, secp256k1_ge *lpt_arr, secp256k1_ge *rpt_arr, const size_t depth, secp256k1_ecmult_multi_callback *cb, void *cb_data, const unsigned char *commit_inp) {
    size_t n;
    secp256k1_scalar zero;
    size_t i;
    unsigned char commit[32];
    ...
    if (!secp256k1_scratch_resize(scratch, error_callback, 2 * n * (sizeof(secp256k1_scalar) + sizeof(secp256k1_gej)), 4)) {
        return 0;
    }
