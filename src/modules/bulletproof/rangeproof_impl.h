...
static int secp256k1_bulletproof_rangeproof_verify_impl(const secp256k1_ecmult_context *ecmult_ctx, secp256k1_scratch *scratch, const secp256k1_callback *error_callback, const unsigned char *proof, size_t plen, size_t nbits, const secp256k1_ge *commitp, const secp256k1_ge *genp, const secp256k1_ge *geng, const secp256k1_ge *genh, const unsigned char *extra_commit, size_t extra_commit_len) {
    ...
    return secp256k1_bulletproof_inner_product_verify_impl(ecmult_ctx, scratch, error_callback, geng, genh, &ecmult_data.t, &age, &mu, secp256k1_bulletproof_vfy_ecmult_callback, (void *) &ecmult_data, 5, &a, &b, lpt, rpt, depth, commit);
}

SECP256K1_INLINE static void secp256k1_bulletproof_rangeproof_genrand_pair(secp256k1_rfc6979_hmac_sha256_t *rng, secp256k1_scalar *out1, secp256k1_scalar *out2) {
...
static void secp256k1_lr_generator_init(secp256k1_bulletproof_lr_generator *generator, const secp256k1_rfc6979_hmac_sha256_t *rng, const secp256k1_scalar *y, const secp256k1_scalar *z, uint64_t val) {
 ...
 */
static int secp256k1_bulletproof_rangeproof_prove_impl(const secp256k1_ecmult_gen_context *ecmult_gen_ctx, const secp256k1_ecmult_context *ecmult_ctx, secp256k1_scratch *scratch, const secp256k1_callback *error_callback, unsigned char *proof, size_t *plen, const size_t nbits, const uint64_t value, const secp256k1_scalar *blind, const secp256k1_ge *commitp, const secp256k1_ge *genp, const secp256k1_ge *geng, const secp256k1_ge *genh, const unsigned char *nonce, const unsigned char *extra_commit, size_t extra_commit_len) {
    secp256k1_bulletproof_lr_generator lr_gen;
    ...
    secp256k1_bulletproof_inner_product_prove_impl(ecmult_ctx, scratch, error_callback, &a, &b, &out_pt[4], &out_pt[4 + depth], depth, secp256k1_bulletproof_abgh_callback, (void *) &abgh_data, commit);
